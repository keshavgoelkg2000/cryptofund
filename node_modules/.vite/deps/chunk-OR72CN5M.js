  ...
  "node_modules/@account-abstraction/sdk/dist/src/BaseAccountAPI.js"(exports) {
    ...
    var BaseAccountAPI2 = class {
      ...
      async encodeUserOpCallDataAndGasLimit(detailsForUserOp) {
        var _a, _b;
        function parseNumber2(a) {
          if (a == null || a === "")
            return null;
          return ethers_1.BigNumber.from(a.toString());
        }
        const value = (_a = parseNumber2(detailsForUserOp.value)) !== null && _a !== void 0 ? _a : ethers_1.BigNumber.from(0);
        const callData = await this.encodeExecute(detailsForUserOp.target, value, detailsForUserOp.data);
        const callGasLimit = (_b = parseNumber2(detailsForUserOp.gasLimit)) !== null && _b !== void 0 ? _b : await this.provider.estimateGas({
...
var randomNonce = () => {
  ...
  return ethers_exports.BigNumber.from(ethers_exports.utils.concat([hexString, "0x0000000000000000"]));
};
var SIG_SIZE = 65;
...
var SmartWalletConnector = class extends Connector {
  ...
  async estimateRaw(transaction) {
    ...
    const tx = await ethers_exports.utils.resolveProperties(transaction);
    return this.estimateTx({
      target: tx.to || import_utils.AddressZero,
  ...
  async prepareBatchRaw(transactions) {
    ...
    const targets = resolvedTxs.map((tx) => tx.to || import_utils.AddressZero);
...
//# sourceMappingURL=chunk-OR72CN5M.js.map
