...
// node_modules/@thirdweb-dev/react-core/dist/useTransactions-7a35b4d7.browser.esm.js
init_shim();
...
// node_modules/@thirdweb-dev/auth/dist/auth-ffe5a232.browser.esm.js
init_shim();
init_lib();
...
function ThirdwebWalletProvider(props) {
  ...
  const [connectionStatus, setConnectionStatus] = (0, import_react6.useState)("unknown");
  ...
  const storeLastActiveChainId = (0, import_react6.useCallback)(async (chainId) => {
  ...
  const onWalletDisconnect = (0, import_react6.useCallback)(async () => {
...
// node_modules/@thirdweb-dev/react/dist/formElements-33f68cb9.browser.esm.js
init_shim();
...
var Img = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)("img", {
    width: props.width,
    height: props.height,
    src: getSrc(),
    alt: props.alt || "",
...
var WalletModalOpen = (0, import_react9.createContext)(false);
var SetWalletModalOpen = (0, import_react9.createContext)(void 0);
var ModalConfigCtx = (0, import_react9.createContext)({
  title: "",
  theme: "dark",
  data: void 0,
  modalSize: "wide"
});
var SetModalConfigCtx = (0, import_react9.createContext)(() => {
});
var WalletUIStatesProvider = (props) => {
  const [isWalletModalOpen, setIsWalletModalOpen] = (0, import_react9.useState)(false);
  const _isMobile = isMobile();
  const [modalConfig, setModalConfig] = (0, import_react9.useState)({
...
var useIsWalletModalOpen = () => {
  return (0, import_react9.useContext)(WalletModalOpen);
};
var useSetIsWalletModalOpen = () => {
  const context = (0, import_react9.useContext)(SetWalletModalOpen);
  if (context === void 0) {
...
var TextDividerEl = newStyled.div`
  display: flex;
  align-items: center;
  color: ${(p) => p.theme.colors.secondaryText};
...
function TOS(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(Container, {
    flex: "row",
    center: "x",
    children: (0, import_jsx_runtime3.jsxs)(Text, {
      size: "xs",
      multiline: true,
      balance: true,
      inline: true,
      ...
      children: ["By connecting, you agree to the", " ", termsOfServiceUrl && (0, import_jsx_runtime3.jsxs)(Link, {
        inline: true,
        size: "xs",
      ...
      }), bothGiven && "& ", privacyPolicyUrl && (0, import_jsx_runtime3.jsx)(Link, {
        inline: true,
        size: "xs",
...
var WalletSelector = (props) => {
  ...
  const [isWalletGroupExpanded, setIsWalletGroupExpanded] = (0, import_react9.useState)(false);
  ...
  const continueAsGuest = localWalletConfig && (0, import_jsx_runtime3.jsx)(Button, {
    fullWidth: true,
  ...
  const enableTWIconLink = (0, import_react9.useRef)(false);
  (0, import_react9.useEffect)(() => {
    setTimeout(() => {
      enableTWIconLink.current = true;
    }, 1e3);
  }, []);
  const twTitle = (0, import_jsx_runtime3.jsxs)(Container, {
    gap: "xxs",
    center: "y",
    flex: "row",
    children: [modalConfig.titleIconUrl === void 0 ? (0, import_jsx_runtime3.jsx)(Link, {
      color: "primaryText",
      ...
      children: (0, import_jsx_runtime3.jsx)(TWIcon, {
        size: iconSize.md
      })
    }) : modalConfig.titleIconUrl === "" ? null : (0, import_jsx_runtime3.jsx)(Img, {
      src: modalConfig.titleIconUrl,
      width: iconSize.md,
      height: iconSize.md
    }), (0, import_jsx_runtime3.jsxs)(ModalTitle, {
  ...
  const connectAWallet = (0, import_jsx_runtime3.jsxs)(Button, {
    fullWidth: true,
    variant: "outline",
    style: {
      display: "flex",
    ...
    children: [(0, import_jsx_runtime3.jsx)(Container, {
      flex: "row",
      gap: "xxs",
      children: eoaWallets.slice(0, 2).map((w) => (0, import_jsx_runtime3.jsx)(Img, {
        width: iconSize.sm,
        height: iconSize.sm,
        src: w.meta.iconURL
      }, w.id))
  ...
  const newToWallets = (0, import_jsx_runtime3.jsxs)(Container, {
    flex: "row",
    style: {
    ...
    }), (0, import_jsx_runtime3.jsx)(Link, {
      weight: 500,
      size: "sm",
      target: "_blank",
  ...
  const tos = termsOfServiceUrl || privacyPolicyUrl ? (0, import_jsx_runtime3.jsx)(TOS, {
    termsOfServiceUrl,
    privacyPolicyUrl
  }) : void 0;
  let topSection;
  let bottomSection;
  if (!isCompact) {
    topSection = (0, import_jsx_runtime3.jsx)(WalletSelection, {
      walletConfigs: nonLocalWalletConfigs,
      selectWallet: handleSelect
    });
    if (continueAsGuest) {
      bottomSection = (0, import_jsx_runtime3.jsx)(ScreenBottomContainer, {
    ...
    if (socialWallets.length === 0) {
      ...
      bottomSection = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
        children: [(0, import_jsx_runtime3.jsx)(Line, {}), (0, import_jsx_runtime3.jsxs)(Container, {
          flex: "column",
          p: "lg",
          gap: "lg",
          children: [newToWallets, continueAsGuest]
        }), !continueAsGuest && (0, import_jsx_runtime3.jsx)(Line, {}), tos && (0, import_jsx_runtime3.jsx)(Container, {
          px: "md",
          style: {
      ...
      if (!isWalletGroupExpanded) {
        topSection = (0, import_jsx_runtime3.jsxs)(Container, {
          px: "xs",
          children: [(0, import_jsx_runtime3.jsx)(WalletSelection, {
            walletConfigs: socialWallets,
            selectWallet: handleSelect
          }), eoaWallets.length > 0 && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
            children: [(0, import_jsx_runtime3.jsx)(TextDivider, {
              text: "OR"
            }), (0, import_jsx_runtime3.jsx)(Spacer, {
              y: "lg"
            })]
          })]
        });
        if (eoaWallets.length === 0) {
          bottomSection = tos || continueAsGuest ? (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
            children: [(0, import_jsx_runtime3.jsx)(Spacer, {
              y: "md"
            }), (0, import_jsx_runtime3.jsx)(Line, {}), continueAsGuest && (0, import_jsx_runtime3.jsxs)(Container, {
              p: "lg",
              children: [" ", continueAsGuest]
            }), tos && (0, import_jsx_runtime3.jsxs)(Container, {
              p: "md",
              children: [" ", tos, " "]
            })]
          }) : (0, import_jsx_runtime3.jsx)(Spacer, {
          ...
          if (eoaWallets.length > 1) {
            bottomSection = (0, import_jsx_runtime3.jsxs)(Container, {
              flex: "column",
              gap: "sm",
              children: [(0, import_jsx_runtime3.jsxs)(Container, {
                px: "lg",
                flex: "column",
                gap: "md",
            ...
            bottomSection = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
              ...
              }), continueAsGuest && (0, import_jsx_runtime3.jsx)(Container, {
                flex: "column",
                px: "lg",
                gap: "lg",
                children: continueAsGuest
              }), tos ? (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, {
                children: [continueAsGuest ? (0, import_jsx_runtime3.jsx)(Spacer, {
                  y: "md"
                }) : (0, import_jsx_runtime3.jsx)(Line, {}), (0, import_jsx_runtime3.jsxs)(Container, {
                  p: "md",
                  children: [" ", tos, " "]
                })]
              }) : (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {
                children: continueAsGuest && (0, import_jsx_runtime3.jsx)(Spacer, {
                  y: "xl"
                })
              })]
  ...
  return (0, import_jsx_runtime3.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime3.jsx)(Container, {
      p: "lg",
      children: isWalletGroupExpanded ? (0, import_jsx_runtime3.jsx)(ModalHeader, {
        title: twTitle,
        onBack: () => {
          setIsWalletGroupExpanded(false);
        }
      }) : twTitle
    }), (0, import_jsx_runtime3.jsx)(Container, {
      expand: true,
      scrollY: true,
      px: "md",
      style: {
...
var WalletSelection = (props) => {
  const modalConfig = (0, import_react9.useContext)(ModalConfigCtx);
  const setModalConfig = (0, import_react9.useContext)(SetModalConfigCtx);
  const walletConfigs = sortWalletConfigs(props.walletConfigs);
  return (0, import_jsx_runtime3.jsx)(WalletList, {
    children: walletConfigs.map((walletConfig) => {
      return (0, import_jsx_runtime3.jsx)("li", {
        "data-full-width": !!walletConfig.selectUI,
        children: walletConfig.selectUI ? (0, import_jsx_runtime3.jsx)(walletConfig.selectUI, {
          ...
          walletConfig
        }) : (0, import_jsx_runtime3.jsx)(WalletEntryButton, {
          walletConfig,
          selectWallet: () => {
            props.selectWallet(walletConfig);
          }
...
function WalletEntryButton(props) {
  ...
  return (0, import_jsx_runtime3.jsxs)(WalletButton, {
    type: "button",
    onClick: () => {
      selectWallet();
    },
    children: [(0, import_jsx_runtime3.jsx)(Img, {
      ...
      }), isRecommended && (0, import_jsx_runtime3.jsx)(Text, {
        size: "sm",
        children: "Recommended"
      }), !isRecommended && walletConfig.isInstalled && walletConfig.isInstalled() && (0, import_jsx_runtime3.jsx)(Text, {
        size: "sm",
        children: "Installed"
      })]
    })]
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-MJO5JNCB.js.map
