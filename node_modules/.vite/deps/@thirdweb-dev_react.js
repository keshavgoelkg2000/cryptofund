import {
  walletConnectV1
} from "./chunk-WITOWAWS.js";
import {
  magicLink
} from "./chunk-U3YMFTVV.js";
import {
  safeWallet
} from "./chunk-G24336YO.js";
import {
  frameWallet
} from "./chunk-JTRCS44A.js";
import {
  ConnectingScreen,
  ...
  walletConnect,
  zerionWallet
} from "./chunk-PAWHDZWX.js";
import {
  bloctoWallet
} from "./chunk-E44AY3BV.js";
import {
  GoogleIcon,
  OTPInput,
  openGoogleSignInWindow,
  paperWallet
} from "./chunk-JZVOVGZT.js";
import {
...
import {
  StandardErc721
} from "./chunk-KNJRUXJH.js";
import {
  DropErc1155History
} from "./chunk-S4OCKZY7.js";
import {
  PAPER_API_URL,
  PaperCheckout,
...
import "./chunk-MD4EOBS2.js";
import "./chunk-3327Y7YD.js";
import "./chunk-KAA6TFSL.js";
...
// node_modules/@thirdweb-dev/react/dist/useWalletConnect-ab184ca8.browser.esm.js
init_shim();
...
function useToken2(tokenAddress) {
  var _a;
  const balanceQuery = useBalance(tokenAddress);
  const chain = useChain();
...
var ConnectedWalletDetails = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    ...
    }), (0, import_jsx_runtime.jsx)(NetworkSelector, {
...
function ConnectedToSmartWallet() {
  ...
  (0, import_react14.useEffect)(() => {
    if (activeWallet && activeWallet.walletId === walletIds.smartWallet) {
      const smartWallet2 = activeWallet;
      smartWallet2.isDeployed().then((isDeployed) => {
...
var SignatureScreen = (_ref) => {
  ...
  const [tryId, setTryId] = (0, import_react14.useState)(0);
  ...
  const signIn = (0, import_react14.useCallback)(async () => {
    var _a;
    try {
      setStatus("signing");
      await wait(1e3);
    ...
    children: [(0, import_jsx_runtime.jsx)(Container, {
      ...
      children: status === "idle" ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [walletConfig && (0, import_jsx_runtime.jsx)(Container, {
          ...
          center: true,
          multiline: true,
          children: ["Please sign the message request ", (0, import_jsx_runtime.jsx)("br", {}), "in your wallet to continue"]
        }), (0, import_jsx_runtime.jsx)(Spacer, {
          y: "md"
        ...
        children: [walletConfig && (0, import_jsx_runtime.jsx)(Container, {
          ...
          children: [(0, import_jsx_runtime.jsx)(Text, {
            ...
            center: true,
            color: "primaryText",
            children: status === "failed" ? "Failed to sign in" : "Awaiting Confirmation"
          }), status === "signing" && (0, import_jsx_runtime.jsx)(Text, {
            center: true,
            multiline: true,
            children: isSafeWallet ? (0, import_jsx_runtime.jsx)(SafeWalletInstruction, {}) : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            ...
            children: [(0, import_jsx_runtime.jsx)(Spacer, {
              ...
              children: [" ", "Approve transaction in Safe", " ", (0, import_jsx_runtime.jsx)(ExternalLinkIcon, {
                width: iconSize.sm,
                height: iconSize.sm
              })]
            })]
...
function SafeWalletInstruction() {
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
    children: isSafePersonalWalletHeadless ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
      children: "Approve transaction in Safe"
    }) : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
      children: ["Sign signature request in your wallet ", (0, import_jsx_runtime.jsx)("br", {}), " & approve transaction in Safe"]
    })
  });
}
function HeadlessSignIn(_ref2) {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsx)(ModalHeader, {
      ...
      children: status === "failed" ? (0, import_jsx_runtime.jsxs)(Container, {
        flex: "column",
        gap: "lg",
        color: "danger",
        center: "both",
...
`;
var PulsatingContainer = newStyled.div`
  position: relative;
...
function StartScreen() {
  ...
  return (0, import_jsx_runtime.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime.jsxs)(Container, {
      ...
      }), showTOS && (0, import_jsx_runtime.jsx)(TOS, {
        termsOfServiceUrl,
        privacyPolicyUrl
      })]
    })]
...
var ConnectModalContent = (props) => {
  ...
  const handleConnected = (0, import_react14.useCallback)(() => {
    var _a2;
  ...
  }, [(_a = modalConfig.auth) == null ? void 0 : _a.loginOptional, authConfig == null ? void 0 : authConfig.authUrl, user == null ? void 0 : user.address, setIsWalletModalOpen, setScreen, initialScreen, setHideModal]);
  ...
  return (0, import_jsx_runtime.jsx)(ScreenContext.Provider, {
    ...
    children: isWideModal ? (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [(0, import_jsx_runtime.jsxs)(LeftContainer, {
        ...
        scrollY: true,
        relative: true,
        children: [screen === reservedScreens.signIn && (0, import_jsx_runtime.jsx)(SignatureScreen, {
          onDone: closeModal,
          modalSize,
          termsOfServiceUrl: modalConfig.termsOfServiceUrl,
          privacyPolicyUrl: modalConfig.privacyPolicyUrl
        }), screen === reservedScreens.main && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {
          children: getStarted
...
var ConnectModal = () => {
  ...
  const isWalletModalOpen = useIsWalletModalOpen();
  const setIsWalletModalOpen = useSetIsWalletModalOpen();
  const [hideModal, setHideModal] = (0, import_react14.useState)(false);
  const connectionStatus = useConnectionStatus();
  ...
  return (0, import_jsx_runtime.jsx)(CustomThemeProvider, {
    ...
    children: (0, import_jsx_runtime.jsx)(Modal, {
      ...
      setOpen: (value) => {
        ...
        if (!value) {
          const requiresSignIn = (auth == null ? void 0 : auth.loginOptional) ? false : !!(authConfig == null ? void 0 : authConfig.authUrl) && !(user == null ? void 0 : user.address);
          onModalUnmount(() => {
...
var ModelViewer = (0, import_react14.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-OTLKPC6X.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
...
var VideoPlayer = (() => import_react14.default.forwardRef(function Video_Player(_ref2, ref) {
  let {
    src,
    alt,
    poster,
...
var AudioPlayer = (() => import_react14.default.forwardRef(function Audio_Player(_ref3, ref) {
  let {
    src,
    alt,
    poster,
...
var IframePlayer = (() => import_react14.default.forwardRef(function Iframe_Player(_ref4, ref) {
  let {
    src,
    alt,
    poster,
...
var LinkPlayer = (() => import_react14.default.forwardRef(function Link_Player(_ref5, ref) {
  let {
    src,
    alt,
    style,
...
var MediaRenderer = (() => import_react14.default.forwardRef(function Media_Renderer(_ref6, ref) {
  let {
    src,
    poster,
    alt,
...
var ThirdwebNftMedia = (() => import_react14.default.forwardRef(function Thirdweb_NftMedia(_ref, ref) {
  var _a;
  let {
    metadata,
    width = "300px",
...
function useRainbowWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet: rainbowWallet2
    } = await import("./safeChainSlug-b497b340.browser.esm-5G2JLH6G.js").then(function(n) {
      return n.R;
    });
    return connect(rainbowWallet2(), connectOptions);
  }, [connect]);
}
function useTrustWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      trustWallet: trustWallet2
    } = await import("./safeChainSlug-b497b340.browser.esm-5G2JLH6G.js").then(function(n) {
      return n.T;
    });
    return connect(trustWallet2(), connectOptions);
  }, [connect]);
}
...
function useFrameWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    ...
    } = await import("./frameWallet-7d2db702.browser.esm-3PHHPZRI.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      bloctoWallet: bloctoWallet2
    } = await import("./bloctoWallet-41e93ea8.browser.esm-RAOA6LVJ.js");
    return connect(bloctoWallet2({
...
function usePaperWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-cec67362.browser.esm-JM74XVVY.js").then(function(n) {
      return n.a;
    });
...
function useWalletConnectV1() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./walletConnectV1-b3216193.browser.esm-OFEPJSRK.js");
...
// node_modules/@thirdweb-dev/react/dist/useSafe-b22cb1d1.browser.esm.js
init_shim();
...
function useSafe() {
  ...
  return (0, import_react16.useCallback)(async (connectProps) => {
    ...
    } = await import("./safeWallet-7990fd4a.browser.esm-YDK3KQLR.js");
    return connect(safeWallet2(), connectProps);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useMagic-7d945dce.browser.esm.js
init_shim();
...
function useMagic() {
  ...
  return (0, import_react17.useCallback)(async (options) => {
    ...
    } = await import("./magicLink-950b0167.browser.esm-6KL2C2DA.js");
...
function useSmartWallet() {
  const connect = useConnect();
  return (0, import_react18.useCallback)(async (wallet, options) => {
    const {
...
var EmbeddedWalletFormUIScreen = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime2.jsx)(ModalHeader, {
      ...
      children: (0, import_jsx_runtime2.jsx)(EmbeddedWalletFormUI, {
...
var EmbeddedWalletOTPLoginUI = (props) => {
  ...
  const [otpInput, setOtpInput] = (0, import_react18.useState)("");
  const {
    createWalletInstance,
    setConnectedWallet,
    setConnectionStatus
  } = useWalletContext();
  const [wallet, setWallet] = (0, import_react18.useState)(null);
  const isWideModal = props.modalSize === "wide";
  const [verifyStatus, setVerifyStatus] = (0, import_react18.useState)("idle");
  const [sendEmailOtpStatus, setSendEmailOtpStatus] = (0, import_react18.useState)("sending");
  const sendEmail = (0, import_react18.useCallback)(async () => {
    setOtpInput("");
  ...
  const emailSentOnMount = (0, import_react18.useRef)(false);
  (0, import_react18.useEffect)(() => {
    ...
    children: [(0, import_jsx_runtime2.jsx)(Container, {
      ...
      children: (0, import_jsx_runtime2.jsxs)("form", {
        ...
        children: [(0, import_jsx_runtime2.jsxs)("div", {
          ...
          children: [sendEmailOtpStatus === "error" && (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {
            children: (0, import_jsx_runtime2.jsx)(Text, {
              size: "sm",
              center: true,
              color: "danger",
          ...
          }), sendEmailOtpStatus === "sending" && (0, import_jsx_runtime2.jsxs)(Container, {
            flex: "row",
            center: "both",
            gap: "xs",
            style: {
          ...
          }), sendEmailOtpStatus === "sent" && (0, import_jsx_runtime2.jsx)(LinkButton, {
            onClick: sendEmail,
            type: "button",
...
var embeddedWallet = (config) => {
  return {
    ...
    selectUI(props) {
      return (0, import_jsx_runtime2.jsx)(EmbeddedWalletSelectionUI, {
        ...props
      });
    },
    connectUI(props) {
      return (0, import_jsx_runtime2.jsx)(EmbeddedWalletConnectUI, {
        ...props
      });
    }
  };
...
var EmbeddedWalletConnectUI = (props) => {
  const [loginType, setLoginType] = (0, import_react18.useState)(props.selectionData);
  if (loginType) {
    const handleBack = () => {
    ...
    if ("email" in loginType) {
      return (0, import_jsx_runtime2.jsx)(EmbeddedWalletOTPLoginUI, {
        ...props,
        selectionData: loginType.email,
        goBack: handleBack
      });
    } else {
      return (0, import_jsx_runtime2.jsx)(EmbeddedWalletGoogleLogin, {
        ...props,
        goBack: handleBack
      });
    }
  }
  return (0, import_jsx_runtime2.jsx)(EmbeddedWalletFormUIScreen, {
      ...
      children: [(0, import_jsx_runtime2.jsx)("input", {
        ...
        children: !uploaded ? (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
          children: [" ", (0, import_jsx_runtime2.jsx)(UploadIconSecondary, {
            ...
            y: "lg"
          }), error ? (0, import_jsx_runtime2.jsxs)(Text, {
            color: "danger",
            size: "sm",
          ...
          children: [(0, import_jsx_runtime2.jsxs)(Text, {
            ...
            color: "success",
            children: (0, import_jsx_runtime2.jsx)(CheckCircleIcon, {
              size: iconSize.xl
            })
          })]
        })
...
var ImportLocalWallet = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Container, {
    ...
    }), (0, import_jsx_runtime2.jsx)(Line, {}), (0, import_jsx_runtime2.jsxs)(Container, {
      p: "lg",
      children: [(0, import_jsx_runtime2.jsx)(ModalDescription, {
...
var CreateLocalWallet_Password = (props) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime2.jsx)(Container, {
      ...
      expand: true,
      p: "lg",
      children: [(0, import_jsx_runtime2.jsxs)(ModalDescription, {
        children: ["Choose a password for your wallet ", (0, import_jsx_runtime2.jsx)("br", {}), " You", `'`, "ll be able to access and export this wallet with the same password"]
      }), (0, import_jsx_runtime2.jsx)(Spacer, {
        y: "lg"
      }), (0, import_jsx_runtime2.jsxs)("form", {
        onSubmit: (e) => {
      ...
      y: "sm"
    }), (0, import_jsx_runtime2.jsx)(Line, {}), (0, import_jsx_runtime2.jsx)(Container, {
      p: "lg",
      children: (0, import_jsx_runtime2.jsx)(Button, {
        fullWidth: true,
        variant: "link",
...
var OverrideConfirmation = (props) => {
  const isCompact = (0, import_react18.useContext)(ModalConfigCtx).modalSize === "compact";
  return (0, import_jsx_runtime2.jsxs)(Container, {
    fullHeight: true,
    flex: "column",
    animate: "fadein",
    ...
    children: [(0, import_jsx_runtime2.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime2.jsx)(Text, {
        ...
        children: [(0, import_jsx_runtime2.jsx)("input", {
          ...
          children: ["Continue", isConnecting && (0, import_jsx_runtime2.jsx)(Spinner, {
            size: "sm",
            color: "accentButtonText"
          })]
        })]
...
var SmartWalletConnecting = (props) => {
  ...
  const switchChain = useSwitchChain();
  const modalSize = (0, import_react18.useContext)(ModalConfigCtx).modalSize;
  const handleConnect = (0, import_react18.useCallback)(async () => {
...
var smartWallet = (wallet, config) => {
  ...
  return {
    ...
    selectUI: WalletSelectUI ? (props) => {
      return (0, import_jsx_runtime2.jsx)(WalletSelectUI, {
        ...props,
        walletConfig: wallet
      });
    } : void 0,
...
var OKXConnectUI = (props) => {
  ...
  const connect = useConnect();
  const [errorConnecting, setErrorConnecting] = (0, import_react18.useState)(false);
  const hideBackButton = props.supportedWallets.length === 1;
  const connectToExtension = (0, import_react18.useCallback)(async () => {
    try {
  ...
  if (screen === "scanning") {
    return (0, import_jsx_runtime2.jsx)(OKXScan, {
      onBack: props.goBack,
...
export {
  ...
  GAS_LIMIT_FOR_DEPLOYER,
  GasCostEstimator,
  GenericRequest$1 as GenericRequest,
  InjectedWallet,
  InterfaceId_IERC1155,
  InterfaceId_IERC721,
  InvalidAddressError,
