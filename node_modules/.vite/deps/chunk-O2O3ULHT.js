import {
  ...
  init_lib18 as init_lib15,
  init_lib19 as init_lib16,
  init_lib2,
  init_lib3,
  init_lib4,
...
var import_bech32, __awaiter, logger3, MAX_CCIP_REDIRECTS, PollableEvents, Event, coinInfos, matcherIpfs, matchers, Resolver, defaultFormatter, nextPollId, BaseProvider;
...
var __awaiter2, logger4, errorGas, _constructorGuard, JsonRpcSigner, UncheckedJsonRpcSigner, allowedTransactionKeys, JsonRpcProvider;
    ...
    JsonRpcSigner = class extends Signer {
      ...
      sendUncheckedTransaction(transaction) {
        ...
        if (transaction.to != null) {
          transaction.to = Promise.resolve(transaction.to).then((to) => __awaiter2(this, void 0, void 0, function* () {
            if (to == null) {
              return null;
            }
      ...
      sendTransaction(transaction) {
        return __awaiter2(this, void 0, void 0, function* () {
          ...
          try {
            return yield poll(() => __awaiter2(this, void 0, void 0, function* () {
...
var __awaiter3, logger5, NextId, WebSocketProvider;
...
var __awaiter4, logger6, StaticJsonRpcProvider, UrlJsonRpcProvider;
  ...
  "node_modules/@ethersproject/providers/lib.esm/url-json-rpc-provider.js"() {
    ...
    UrlJsonRpcProvider = class extends StaticJsonRpcProvider {
      constructor(network, apiKey) {
        logger6.checkAbstract(new.target, UrlJsonRpcProvider);
...
var __awaiter5, logger9, CloudflareProvider;
...
var __awaiter6, logger10, EtherscanProvider;
  ...
  for (let i = 0; i < networks2.length; i++) {
    ...
    if (result) {
      if (!(result.name === network.name && result.chainId === network.chainId && (result.ensAddress === network.ensAddress || result.ensAddress == null && network.ensAddress == null))) {
        logger11.throwArgumentError("provider mismatch", "networks", networks2);
      }
    } else {
      result = network;
    }
...
var __awaiter7, logger11, nextRid, ForwardErrors, ForwardProperties, FallbackProvider;
...
export {
  getDefaultProvider,
  lib_exports,
  init_lib18 as init_lib
};
//# sourceMappingURL=chunk-O2O3ULHT.js.map
