import { BigNumber, BigNumberish, providers, BytesLike } from "ethers";
...
export declare abstract class BaseAccountAPI {
    ...
    encodeUserOpCallDataAndGasLimit(detailsForUserOp: TransactionDetailsForUserOp, batchData?: BatchData): Promise<{
        callData: string;
     ...
     * @param info
     */
    createUnsignedUserOp(info: TransactionDetailsForUserOp, batchData?: BatchData): Promise<UserOperationStruct>;
    /**
     ...
     */
    createSignedUserOp(info: TransactionDetailsForUserOp, batchData?: BatchData): Promise<UserOperationStruct>;
    /**
