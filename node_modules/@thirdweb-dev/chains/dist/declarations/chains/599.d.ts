declare const _default: {
    ...
    readonly rpc: readonly ["https://metis-goerli-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://599.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://goerli.gateway.metisdevops.link"];
