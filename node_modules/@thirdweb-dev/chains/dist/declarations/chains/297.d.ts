declare const _default: {
    ...
    readonly rpc: readonly ["https://hedera-previewnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://297.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://previewnet.hashio.io/api"];
