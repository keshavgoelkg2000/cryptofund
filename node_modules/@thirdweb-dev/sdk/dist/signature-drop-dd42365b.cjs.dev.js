...
class SignatureDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new smartContract.ContractRoles(this.contractWrapper, SignatureDrop.contractRoles);
    ...
    this.signature = new smartContract.Erc721WithQuantitySignatureMintable(this.contractWrapper, this.storage);
   ...
   */
  claimTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (destinationAddress, quantity, options) => {
   ...
   * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
   */
  claim = /* @__PURE__ */smartContract.buildTransactionFunction(async (quantity, options) => {
