...
class StandardErc20 {
  ...
  constructor(contractWrapper, storage, chainId) {
    ...
    this.erc20 = new smartContract.Erc20(this.contractWrapper, this.storage, chainId);
   ...
   * ```
   */
  transfer = /* @__PURE__ */smartContract.buildTransactionFunction(async (to, amount) => {
   ...
   * ```
   */
  transferFrom = /* @__PURE__ */smartContract.buildTransactionFunction(async (from, to, amount) => {
   ...
   * ```
   */
  setAllowance = /* @__PURE__ */smartContract.buildTransactionFunction(async (spender, amount) => {
   ...
   * ```
   */
  transferBatch = /* @__PURE__ */smartContract.buildTransactionFunction(async args => {
