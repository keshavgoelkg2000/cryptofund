...
var erc20History = require('./erc-20-history-8eeac94c.cjs.dev.js');
var erc20Standard = require('./erc-20-standard-eaee1208.cjs.dev.js');
require('zod');
...
class Token extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new smartContract.ContractMetadata(this.contractWrapper, smartContract.TokenErc20ContractSchema, this.storage);
    this.app = new smartContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new smartContract.ContractRoles(this.contractWrapper, Token.contractRoles);
    ...
    this.signature = new smartContract.Erc20SignatureMintable(this.contractWrapper, this.roles);
  }
  ...
  async getDelegationOf(account) {
    return await this.contractWrapper.read("delegates", [await smartContract.resolveAddress(account)]);
  }
   ...
   */
  mint = /* @__PURE__ */smartContract.buildTransactionFunction(async amount => {
   ...
   * ```
   */
  mintTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (to, amount) => {
   ...
   * ```
   */
  mintBatchTo = /* @__PURE__ */smartContract.buildTransactionFunction(async args => {
   ...
   * @alpha
   */
  delegateTo = /* @__PURE__ */smartContract.buildTransactionFunction(async delegateeAddress => {
    return smartContract.Transaction.fromContractWrapper({
      contractWrapper: this.contractWrapper,
      method: "delegate",
      args: [await smartContract.resolveAddress(delegateeAddress)]
    });
  });
   ...
   * ```
   */
  burn = /* @__PURE__ */smartContract.buildTransactionFunction(amount => {
   ...
   * ```
   */
  burnFrom = /* @__PURE__ */smartContract.buildTransactionFunction(async (holder, amount) => {
