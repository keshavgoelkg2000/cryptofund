...
class StandardErc1155 {
  ...
  constructor(contractWrapper, storage, chainId) {
    ...
    this.erc1155 = new smartContract.Erc1155(this.contractWrapper, this.storage, chainId);
   ...
   * ```
   */
  transfer = /* @__PURE__ */smartContract.buildTransactionFunction((() => {
    var _this = this;
   ...
   * ```
   */
  airdrop = /* @__PURE__ */smartContract.buildTransactionFunction((() => {
    var _this2 = this;
