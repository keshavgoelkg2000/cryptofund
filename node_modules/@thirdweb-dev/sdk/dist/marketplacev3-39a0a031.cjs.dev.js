...
class MarketplaceV3 {
   ...
   */
  get directListings() {
    return smartContract.assertEnabled(this.detectDirectListings(), smartContract.FEATURE_DIRECT_LISTINGS);
  }
  /**
   * Auctions
   ...
   */
  get englishAuctions() {
    return smartContract.assertEnabled(this.detectEnglishAuctions(), smartContract.FEATURE_ENGLISH_AUCTIONS);
  }
   ...
   */
  get offers() {
    return smartContract.assertEnabled(this.detectOffers(), smartContract.FEATURE_OFFERS);
  }
  get chainId() {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new smartContract.ContractRoles(this.contractWrapper, MarketplaceV3.contractRoles);
  ...
  detectDirectListings() {
    if (smartContract.detectContractFeature(this.contractWrapper, "DirectListings")) {
      return new smartContract.MarketplaceV3DirectListings(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectEnglishAuctions() {
    if (smartContract.detectContractFeature(this.contractWrapper, "EnglishAuctions")) {
      return new smartContract.MarketplaceV3EnglishAuctions(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectOffers() {
    if (smartContract.detectContractFeature(this.contractWrapper, "Offers")) {
      return new smartContract.MarketplaceV3Offers(this.contractWrapper, this.storage);
    }
    return undefined;
  }
}
