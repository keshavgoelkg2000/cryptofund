...
class TokenDrop extends erc20Standard.StandardErc20 {
  static contractRoles = smartContract.TOKEN_DROP_CONTRACT_ROLES;
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new smartContract.ContractMetadata(this.contractWrapper, smartContract.DropErc20ContractSchema, this.storage);
    this.app = new smartContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new smartContract.ContractRoles(this.contractWrapper, TokenDrop.contractRoles);
  ...
  async getVoteBalanceOf(account) {
    return await this.erc20.getValue(await this.contractWrapper.read("getVotes", [await smartContract.resolveAddress(account)]));
  }
   ...
   * ```
   */
  burnTokens = /* @__PURE__ */smartContract.buildTransactionFunction(async amount => {
