...
var erc721Standard = require('./erc-721-standard-9f2869e0.cjs.dev.js');
var thirdwebCheckout = require('./thirdweb-checkout-e64a929a.cjs.dev.js');
require('zod');
...
class NFTDrop extends erc721Standard.StandardErc721 {
  static contractRoles = smartContract.NFT_BASE_CONTRACT_ROLES;
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new smartContract.ContractMetadata(this.contractWrapper, smartContract.DropErc721ContractSchema, this.storage);
    this.app = new smartContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new smartContract.ContractRoles(this.contractWrapper, NFTDrop.contractRoles);
    this.royalties = new smartContract.ContractRoyalty(this.contractWrapper, this.metadata);
    this.sales = new smartContract.ContractPrimarySale(this.contractWrapper);
    this.claimConditions = new smartContract.DropClaimConditions(this.contractWrapper, this.metadata, this.storage);
    ...
    this.revealer = new smartContract.DelayedReveal(this.contractWrapper, this.storage, smartContract.FEATURE_NFT_REVEALABLE.name, () => this.erc721.nextTokenIdToMint());
  ...
  async getAllClaimed(queryParams) {
    ...
    const count = ethers.BigNumber.from(queryParams?.count || smartContract.DEFAULT_QUERY_ALL_COUNT).toNumber();
   ...
   */
  createBatch = /* @__PURE__ */smartContract.buildTransactionFunction(async (metadatas, options) => {
   ...
   */
  claimTo = /* @__PURE__ */smartContract.buildTransactionFunction((() => {
    var _this = this;
   ...
   * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
   */
  claim = /* @__PURE__ */smartContract.buildTransactionFunction((() => {
    var _this2 = this;
   ...
   *
   */
  burn = /* @__PURE__ */smartContract.buildTransactionFunction(async tokenId => {
   ...
   * ```
   */
  transfer = /* @__PURE__ */smartContract.buildTransactionFunction(async (to, tokenId) => {
   ...
   * @internal
   */
  setApprovalForAll = /* @__PURE__ */smartContract.buildTransactionFunction(async (operator, approved) => {
   ...
   * @internal
   */
  setApprovalForToken = /* @__PURE__ */smartContract.buildTransactionFunction(async (operator, tokenId) => {
