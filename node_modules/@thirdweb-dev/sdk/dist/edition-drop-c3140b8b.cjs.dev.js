...
class EditionDrop extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new smartContract.ContractMetadata(this.contractWrapper, smartContract.DropErc1155ContractSchema, this.storage);
    this.app = new smartContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new smartContract.ContractRoles(this.contractWrapper, EditionDrop.contractRoles);
    ...
    this.claimConditions = new smartContract.DropErc1155ClaimConditions(this.contractWrapper, this.metadata, this.storage);
   ...
   * ```
   */
  burnTokens = /* @__PURE__ */smartContract.buildTransactionFunction(async (tokenId, amount) => {
