...
class NFTCollection extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new smartContract.ContractMetadata(this.contractWrapper, smartContract.TokenErc721ContractSchema, this.storage);
    this.app = new smartContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new smartContract.ContractRoles(this.contractWrapper, NFTCollection.contractRoles);
   ...
   * ```
   */
  mint = /* @__PURE__ */smartContract.buildTransactionFunction(async metadata => {
   ...
   * ```
   */
  mintTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (walletAddress, metadata) => {
   ...
   * ```
   */
  mintBatch = /* @__PURE__ */smartContract.buildTransactionFunction(async metadata => {
   ...
   * ```
   */
  mintBatchTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (walletAddress, metadata) => {
   ...
   * ```
   */
  burn = /* @__PURE__ */smartContract.buildTransactionFunction(tokenId => {
