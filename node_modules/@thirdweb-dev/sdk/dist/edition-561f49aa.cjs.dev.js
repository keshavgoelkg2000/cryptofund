...
class Edition extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    this.metadata = new smartContract.ContractMetadata(this.contractWrapper, smartContract.TokenErc1155ContractSchema, this.storage);
    this.app = new smartContract.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new smartContract.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new smartContract.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
   ...
   */
  mint = /* @__PURE__ */smartContract.buildTransactionFunction(async metadataWithSupply => {
   ...
   * ```
   */
  mintTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (to, metadataWithSupply) => {
   ...
   */
  mintAdditionalSupply = /* @__PURE__ */smartContract.buildTransactionFunction(async (tokenId, additionalSupply) => {
   ...
   * @param additionalSupply - the additional amount to mint
   */
  mintAdditionalSupplyTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
   ...
   */
  mintBatch = /* @__PURE__ */smartContract.buildTransactionFunction(async metadatas => {
   ...
   * ```
   */
  mintBatchTo = /* @__PURE__ */smartContract.buildTransactionFunction(async (to, metadataWithSupply) => {
   ...
   * ```
   */
  burn = /* @__PURE__ */smartContract.buildTransactionFunction(async (tokenId, amount) => {
