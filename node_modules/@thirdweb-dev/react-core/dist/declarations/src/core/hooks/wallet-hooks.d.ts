import type { BloctoWallet, CoinbaseWallet, EmbeddedWallet, FrameWallet, LocalWallet, MagicLink, MetaMaskWallet, OKXWallet, PaperWallet, PhantomWallet, RainbowWallet, SafeWallet, SmartWallet, TokenBoundSmartWallet, TrustWallet, WalletConnect, walletIds } from "@thirdweb-dev/wallets";
