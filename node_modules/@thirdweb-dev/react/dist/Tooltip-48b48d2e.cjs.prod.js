...
function useScreen() {
  ...
  const initialScreen = (walletConfigs.length === 1 && !walletConfigs[0]?.selectUI ? walletConfigs[0] : formElements.reservedScreens.main) || formElements.reservedScreens.main;
