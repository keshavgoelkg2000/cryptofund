...
var formElements = require('./formElements-f9ff7570.cjs.prod.js');
var Tooltip = require('./Tooltip-48b48d2e.cjs.prod.js');
...
var coinbaseWallet = require('./safeChainSlug-5b4e4952.cjs.prod.js');
...
const ConnectedWalletDetails = props => {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      }), chain?.explorers && chain.explorers[0]?.url && /*#__PURE__*/jsxRuntime.jsxs(MenuLink, {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(NetworkSelector, {
...
`;
const DropDownContent = /* @__PURE__ */(() => styled__default["default"](DropdownMenu__namespace.Content)`
  width: 320px;
  box-sizing: border-box;
  max-width: 100%;
  border-radius: ${formElements.radius.lg};
...
function ConnectedToSmartWallet() {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    }), isSmartWalletDeployed && /*#__PURE__*/jsxRuntime.jsx(reactIcons.ChevronRightIcon, {
      width: formElements.iconSize.sm,
      height: formElements.iconSize.sm
    })]
  });
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: status === "idle" ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [walletConfig && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          ...
          center: true,
          multiline: true,
          children: ["Please sign the message request ", /*#__PURE__*/jsxRuntime.jsx("br", {}), "in your wallet to continue"]
        }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
          y: "md"
        ...
        children: [walletConfig && /*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Text, {
            ...
            center: true,
            multiline: true,
            children: isSafeWallet ? /*#__PURE__*/jsxRuntime.jsx(SafeWalletInstruction, {}) : /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              ...
              children: [" ", "Approve transaction in Safe", " ", /*#__PURE__*/jsxRuntime.jsx(reactIcons.ExternalLinkIcon, {
                width: formElements.iconSize.sm,
                height: formElements.iconSize.sm
              })]
            })]
...
function SafeWalletInstruction() {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: isSafePersonalWalletHeadless ? /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
      ...
      children: ["Sign signature request in your wallet ", /*#__PURE__*/jsxRuntime.jsx("br", {}), " & approve transaction in Safe"]
    })
  });
}
function HeadlessSignIn(_ref2) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.ModalHeader, {
      ...
      children: status === "failed" ? /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
        flex: "column",
        gap: "lg",
        color: "danger",
        center: "both",
...
`;
const PulsatingContainer = styled__default["default"].div`
  position: relative;
...
function StartScreen() {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      }), showTOS && /*#__PURE__*/jsxRuntime.jsx(formElements.TOS, {
        termsOfServiceUrl: termsOfServiceUrl,
        privacyPolicyUrl: privacyPolicyUrl
      })]
    })]
...
const ConnectModalContent = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Tooltip.ScreenContext.Provider, {
    value: screen,
    children: isWideModal ? /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(LeftContainer, {
        ...
        scrollY: true,
        relative: true,
        children: [screen === formElements.reservedScreens.signIn && /*#__PURE__*/jsxRuntime.jsx(SignatureScreen, {
          onDone: closeModal,
          modalSize: modalSize,
          termsOfServiceUrl: modalConfig.termsOfServiceUrl,
          privacyPolicyUrl: modalConfig.privacyPolicyUrl
        }), screen === formElements.reservedScreens.main && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
          children: getStarted
      ...
      children: [screen === formElements.reservedScreens.signIn && /*#__PURE__*/jsxRuntime.jsx(SignatureScreen, {
        ...
        termsOfServiceUrl: modalConfig.termsOfServiceUrl,
        privacyPolicyUrl: modalConfig.privacyPolicyUrl
      }), screen === formElements.reservedScreens.main && walletList, screen === formElements.reservedScreens.getStarted && getStarted, typeof screen !== "string" && getWalletUI(screen)]
    })
  });
};
const ConnectModal = () => {
  ...
  React.useEffect(() => {
    if (isWalletModalOpen && screen === formElements.reservedScreens.signIn && !wallet) {
      setScreen(initialScreen);
      setIsWalletModalOpen(false);
    }
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-5b4e4952.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-5b4e4952.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-5b4e4952.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-5b4e4952.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-0d4e5a03.cjs.prod.js'); });
...
function useBloctoWallet() {
  ...
  return React.useCallback(async options => {
    const {
      bloctoWallet
    } = await Promise.resolve().then(function () { return require('./bloctoWallet-03e212bf.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-0fab9c0b.cjs.prod.js'); }).then(function (n) { return n.paperWallet$1; });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-1dfcd7ae.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-5b4e4952.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
