...
const TextDividerEl = styled__default["default"].div`
  display: flex;
  align-items: center;
  color: ${p => p.theme.colors.secondaryText};
...
const WalletSelector = props => {
  ...
  const connectAWallet = /*#__PURE__*/jsxRuntime.jsxs(Button, {
    fullWidth: true,
    variant: "outline",
    style: {
      display: "flex",
  ...
  const newToWallets = /*#__PURE__*/jsxRuntime.jsxs(Container, {
    flex: "row",
    style: {
  ...
  if (!isCompact) {
    ...
    if (continueAsGuest) {
      bottomSection = /*#__PURE__*/jsxRuntime.jsx(ScreenBottomContainer, {
  ...
  // compact
    ...
    if (socialWallets.length === 0) {
      ...
      bottomSection = /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(Line, {}), /*#__PURE__*/jsxRuntime.jsxs(Container, {
          flex: "column",
          p: "lg",
          gap: "lg",
          children: [newToWallets, continueAsGuest]
        }), !continueAsGuest && /*#__PURE__*/jsxRuntime.jsx(Line, {}), tos && /*#__PURE__*/jsxRuntime.jsx(Container, {
          px: "md",
          style: {
    ...
    // social logins
      ...
      if (!isWalletGroupExpanded) {
        topSection = /*#__PURE__*/jsxRuntime.jsxs(Container, {
          px: "xs",
          children: [/*#__PURE__*/jsxRuntime.jsx(WalletSelection, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsx(TextDivider, {
              text: "OR"
        ...
        if (eoaWallets.length === 0) {
          bottomSection = tos || continueAsGuest ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
              y: "md"
            }), /*#__PURE__*/jsxRuntime.jsx(Line, {}), continueAsGuest && /*#__PURE__*/jsxRuntime.jsxs(Container, {
              p: "lg",
              children: [" ", continueAsGuest]
            }), tos && /*#__PURE__*/jsxRuntime.jsxs(Container, {
              p: "md",
              children: [" ", tos, " "]
            })]
          }) : /*#__PURE__*/jsxRuntime.jsx(Spacer, {
        ...
        // social login + eoa wallets
          ...
          if (eoaWallets.length > 1) {
            bottomSection = /*#__PURE__*/jsxRuntime.jsxs(Container, {
              flex: "column",
              gap: "sm",
          ...
          // social login + single eoa wallet
            ...
            bottomSection = /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
              ...
              }), continueAsGuest && /*#__PURE__*/jsxRuntime.jsx(Container, {
                flex: "column",
                px: "lg",
                gap: "lg",
                children: continueAsGuest
              }), tos ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
                children: [continueAsGuest ? /*#__PURE__*/jsxRuntime.jsx(Spacer, {
                  y: "md"
                }) : /*#__PURE__*/jsxRuntime.jsx(Line, {}), /*#__PURE__*/jsxRuntime.jsxs(Container, {
                  p: "md",
                  children: [" ", tos, " "]
                })]
