...
import { F as FormFieldWithIconButton, Q as QRCode, s as safeChainIdToSlug, w as wait, W as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets } from './safeChainSlug-eaef8d82.esm.js';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-eaef8d82.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-eaef8d82.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-eaef8d82.esm.js').then(function (n) { return n.g; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-eaef8d82.esm.js').then(function (n) { return n.f; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-4aa5d990.esm.js');
...
function useBloctoWallet() {
  ...
  return useCallback(async options => {
    const {
      bloctoWallet
    } = await import('./bloctoWallet-09ca2b8f.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-7bb93937.esm.js').then(function (n) { return n.a; });
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-50f4242e.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-eaef8d82.esm.js').then(function (n) { return n.h; });
